  ...
  return (
    <main className="p-4 mx-auto w-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Input type="number" min={1} value={hours} onChange={(e) => setHours(Number(e.target.value))} placeholder="Hours volunteered" required />
        <Input type="text" value={role} onChange={(e) => setRole(e.target.value)} placeholder="Role (e.g. Tree Planter)" required />
        ...
        <Input type="text" value={organisation} onChange={(e) => setOrganisation(e.target.value)} placeholder="Organisation (optional)" />
